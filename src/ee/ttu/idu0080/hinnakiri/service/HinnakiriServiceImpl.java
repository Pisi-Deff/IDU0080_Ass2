...
public class HinnakiriServiceImpl implements HinnakiriService {
	...
	public GetHinnakiriResponse getHinnakiri(java.lang.String parameters) 
		throws
			...
			HinnakiriNegativePriceException,
			HinnakiriZeroPriceException,
			HinnakiriPriceTooAccurateException
	{
		...
		if (maximumPrice < 0) {
			throw new HinnakiriNegativePriceException();
		}
		if (maximumPrice == 0) {
			throw new HinnakiriZeroPriceException();
		}
		...
		if (parts.length > 1) {
			...
			if (last.length() > 2) {
				throw new HinnakiriPriceTooAccurateException();
			}
		}
